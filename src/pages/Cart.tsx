...
const Cart = () => {
    ...
    return (
        <div className="cart">
                ...
                <Card className="cartItem" key={book.id}>
                    <CardContent>
                        <Grid container justifyContent="space-between" alignItems="center">
                            ...
                            <Grid item>
                                <IoTrashBinOutline onClick={() => handleRemoveBook(book)} style={{ fontSize: '1.5em', cursor: 'pointer' }}/>
                            </Grid>
                        </Grid>
                    </CardContent>
                </Card>
            ...
            <Button onClick={handleSubmit} variant="contained" color="primary" disabled={cartItems.length === 0}>{t('submitButton')}</Button>
